...
export function getComponentMap(isZh: boolean) {
  return isZh
    ? [
        ...
        [bottomSheet, 'bottomSheet', `<${hyphenate(bottomSheet.name)}></${hyphenate(bottomSheet.name)}>`],
        [calendar, 'calendar', `<${hyphenate(calendar.name)}></${hyphenate(calendar.name)}>`],
        [calendarDay, 'calendarDay', `<${hyphenate(calendarDay.name)}></${hyphenate(calendarDay.name)}>`],
        [calendarHeader, 'calendarHeader', `<${hyphenate(calendarHeader.name)}></${hyphenate(calendarHeader.name)}>`],
        [calendarInterval, 'calendarInterval', `<${hyphenate(calendarInterval.name)}></${hyphenate(calendarInterval.name)}>`],
        [calendarIntervalEvent, 'calendarIntervalEvent', `<${hyphenate(calendarIntervalEvent.name)}></${hyphenate(calendarIntervalEvent.name)}>`],
        [calendarMonthDay, 'calendarMonthDay', `<${hyphenate(calendarMonthDay.name)}></${hyphenate(calendarMonthDay.name)}>`],
        [cardActions, 'cardActions', `<${hyphenate(cardActions.name)}></${hyphenate(cardActions.name)}>`],
        [checkboxBtn, 'checkboxBtn', `<${hyphenate(checkboxBtn.name)}></${hyphenate(checkboxBtn.name)}>`],
        [classIcon, 'classIcon', `<${hyphenate(classIcon.name)}></${hyphenate(classIcon.name)}>`],
        [code, 'code', `<${hyphenate(code.name)}></${hyphenate(code.name)}>`],
        [componentIcon, 'componentIcon', `<${hyphenate(componentIcon.name)}></${hyphenate(componentIcon.name)}>`],
        [confirmEdit, 'confirmEdit', `<${hyphenate(confirmEdit.name)}></${hyphenate(confirmEdit.name)}>`],
        ...
        [dataTableServer, 'dataTableServer', `<${hyphenate(dataTableServer.name)}></${hyphenate(dataTableServer.name)}>`],
        [dataTableVirtual, 'dataTableVirtual', `<${hyphenate(dataTableVirtual.name)}></${hyphenate(dataTableVirtual.name)}>`],
        [datePicker, 'datePicker', `<${hyphenate(datePicker.name)}></${hyphenate(datePicker.name)}>`],
        [datePickerControls, 'datePickerControls', `<${hyphenate(datePickerControls.name)}></${hyphenate(datePickerControls.name)}>`],
        [datePickerHeader, 'datePickerHeader', `<${hyphenate(datePickerHeader.name)}></${hyphenate(datePickerHeader.name)}>`],
        [datePickerMonth, 'datePickerMonth', `<${hyphenate(datePickerMonth.name)}></${hyphenate(datePickerMonth.name)}>`],
        [datePickerMonths, 'datePickerMonths', `<${hyphenate(datePickerMonths.name)}></${hyphenate(datePickerMonths.name)}>`],
        [datePickerYears, 'datePickerYears', `<${hyphenate(datePickerYears.name)}></${hyphenate(datePickerYears.name)}>`],
        [dialogBottomTransition, 'dialogBottomTransition', `<${hyphenate(dialogBottomTransition.name)}></${hyphenate(dialogBottomTransition.name)}>`],
        [dialogTopTransition, 'dialogTopTransition', `<${hyphenate(dialogTopTransition.name)}></${hyphenate(dialogTopTransition.name)}>`],
        [dialogTransition, 'dialogTransition', `<${hyphenate(dialogTransition.name)}></${hyphenate(dialogTransition.name)}>`],
        [expandTransition, 'expandTransition', `<${hyphenate(expandTransition.name)}></${hyphenate(expandTransition.name)}>`],
        [expandXTransition, 'expandXTransition', `<${hyphenate(expandXTransition.name)}></${hyphenate(expandXTransition.name)}>`],
        [fabTransition, 'fabTransition', `<${hyphenate(fabTransition.name)}></${hyphenate(fabTransition.name)}>`],
        [fadeTransition, 'fadeTransition', `<${hyphenate(fadeTransition.name)}></${hyphenate(fadeTransition.name)}>`],
        [field, 'field', `<${hyphenate(field.name)}></${hyphenate(field.name)}>`],
        [fieldLabel, 'fieldLabel', `<${hyphenate(fieldLabel.name)}></${hyphenate(fieldLabel.name)}>`],
        [infiniteScroll, 'infiniteScroll', `<${hyphenate(infiniteScroll.name)}></${hyphenate(infiniteScroll.name)}>`],
        [kbd, 'kbd', `<${hyphenate(kbd.name)}></${hyphenate(kbd.name)}>`],
        [label, 'label', `<${hyphenate(label.name)}></${hyphenate(label.name)}>`],
        [layout, 'layout', `<${hyphenate(layout.name)}></${hyphenate(layout.name)}>`],
        [layoutItem, 'layoutItem', `<${hyphenate(layoutItem.name)}></${hyphenate(layoutItem.name)}>`],
        [ligatureIcon, 'ligatureIcon', `<${hyphenate(ligatureIcon.name)}></${hyphenate(ligatureIcon.name)}>`],
        [main, 'main', `<${hyphenate(main.name)}></${hyphenate(main.name)}>`],
        [messages, 'messages', `<${hyphenate(messages.name)}></${hyphenate(messages.name)}>`],
        [noSsr, 'noSsr', `<${hyphenate(noSsr.name)}></${hyphenate(noSsr.name)}>`],
        [otpInput, 'otpInput', `<${hyphenate(otpInput.name)}></${hyphenate(otpInput.name)}>`],
        [picker, 'picker', `<${hyphenate(picker.name)}></${hyphenate(picker.name)}>`],
        [pickerTitle, 'pickerTitle', `<${hyphenate(pickerTitle.name)}></${hyphenate(pickerTitle.name)}>`],
        [scaleTransition, 'scaleTransition', `<${hyphenate(scaleTransition.name)}></${hyphenate(scaleTransition.name)}>`],
        [scrollXReverseTransition, 'scrollXReverseTransition', `<${hyphenate(scrollXReverseTransition.name)}></${hyphenate(scrollXReverseTransition.name)}>`],
        [scrollXTransition, 'scrollXTransition', `<${hyphenate(scrollXTransition.name)}></${hyphenate(scrollXTransition.name)}>`],
        [scrollYReverseTransition, 'scrollYReverseTransition', `<${hyphenate(scrollYReverseTransition.name)}></${hyphenate(scrollYReverseTransition.name)}>`],
        [scrollYTransition, 'scrollYTransition', `<${hyphenate(scrollYTransition.name)}></${hyphenate(scrollYTransition.name)}>`],
        [selectionControl, 'selectionControl', `<${hyphenate(selectionControl.name)}></${hyphenate(selectionControl.name)}>`],
        [selectionControlGroup, 'selectionControlGroup', `<${hyphenate(selectionControlGroup.name)}></${hyphenate(selectionControlGroup.name)}>`],
        [skeletonLoader, 'skeletonLoader', `<${hyphenate(skeletonLoader.name)}></${hyphenate(skeletonLoader.name)}>`],
        [slideGroup, 'slideGroup', `<${hyphenate(slideGroup.name)}></${hyphenate(slideGroup.name)}>`],
        [slideGroupItem, 'slideGroupItem', `<${hyphenate(slideGroupItem.name)}></${hyphenate(slideGroupItem.name)}>`],
        [slideXReverseTransition, 'slideXReverseTransition', `<${hyphenate(slideXReverseTransition.name)}></${hyphenate(slideXReverseTransition.name)}>`],
        [slideXTransition, 'slideXTransition', `<${hyphenate(slideXTransition.name)}></${hyphenate(slideXTransition.name)}>`],
        [slideYTransition, 'slideYTransition', `<${hyphenate(slideYTransition.name)}></${hyphenate(slideYTransition.name)}>`],
        [slideYReverseTransition, 'slideYReverseTransition', `<${hyphenate(slideYReverseTransition.name)}></${hyphenate(slideYReverseTransition.name)}>`],
        [stepper, 'stepper', `<${hyphenate(stepper.name)}></${hyphenate(stepper.name)}>`],
        [stepperActions, 'stepperActions', `<${hyphenate(stepperActions.name)}></${hyphenate(stepperActions.name)}>`],
        [stepperHeader, 'stepperHeader', `<${hyphenate(stepperHeader.name)}></${hyphenate(stepperHeader.name)}>`],
        [stepperItem, 'stepperItem', `<${hyphenate(stepperItem.name)}></${hyphenate(stepperItem.name)}>`],
        [stepperWindow, 'stepperWindow', `<${hyphenate(stepperWindow.name)}></${hyphenate(stepperWindow.name)}>`],
        [stepperWindowItem, 'stepperWindowItem', `<${hyphenate(stepperWindowItem.name)}></${hyphenate(stepperWindowItem.name)}>`],
        [svgIcon, 'svgIcon', `<${hyphenate(svgIcon.name)}></${hyphenate(svgIcon.name)}>`],
        [validation, 'validation', `<${hyphenate(validation.name)}></${hyphenate(validation.name)}>`],
