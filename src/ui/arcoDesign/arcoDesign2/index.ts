...
import FormItemProvider from './FormItemProvider.json'
...
export function arcoDesign2Components() {
  const map = [
    ...
    [DropdownButton, '下拉按钮', '<DropdownButton></DropdownButton>'],
    [Empty, '空状态', '<Empty></Empty>'],
    [Form, '表单', '<Form></Form>'],
    [FormItem, '表单', '<FormItem></FormItem>'],
    [FormItemList, '表单', '<FormItemList></FormItemList>'],
    [FormItemProvider, '表单', '<FormItemProvider></FormItemProvider>'],
    [Grid, '栅格', '<Grid></Grid>'],
    ...
    [InputGroup, '输入框', '<InputGroup></InputGroup>'],
    [InputNumber, '数字输入框', '<InputNumber></InputNumber>'],
    [InputPassword, '密码输入框', '<InputPassword></InputPassword>'],
    [InputSearch, '搜索输入框', '<InputSearch></InputSearch>'],
    [InputTag, '标签输入框', '<InputTag></InputTag>'],
    [InputTextArea, '文本输入框', '<InputTextArea></InputTextArea>'],
    ...
    [MenuSubMenu, '菜单', '<MenuSubMenu></MenuSubMenu>'],
    ...
    [RangePicker, '区域时间选择器', '<RangePicker></RangePicker>'],
    [Rate, '评分', '<Rate></Rate>'],
    [ResizeBox, '伸缩框', '<ResizeBox></ResizeBox>'],
    [ResizeBoxSplit, '伸缩框', '<ResizeBoxSplit></ResizeBoxSplit>'],
    [ResizeBoxSplitGroup, '伸缩框', '<ResizeBoxSplitGroup></ResizeBoxSplitGroup>'],
    [ResizeBoxSplitGroupCollapsedConfig, '伸缩框', '<ResizeBoxSplitGroupCollapsedConfig></ResizeBoxSplitGroupCollapsedConfig>'],
    ...
    [SelectOption, '选择', '<SelectOption></SelectOption>'],
    [SelectOptionGroup, '选择', '<SelectOptionGroup></SelectOptionGroup>'],
    ...
    [StepsStep, '步骤', '<StepsStep></StepsStep>'],
    [Switch, '切换', '<Switch></Switch>'],
    [Table, '表格', '<Table></Table>'],
    [Tabs, '标签页', '<Tabs></Tabs>'],
    [TabsTabPane, '标签页', '<TabsTabPane></TabsTabPane>'],
    [Tag, '标签', '<Tag></Tag>'],
    [TimePicker, '时间选择器', '<TimePicker></TimePicker>'],
    [TimePickerRangePicker, '时间选择器', '<TimePickerRangePicker></TimePickerRangePicker>'],
    ...
    [TransferItem, '数据穿梭框', '<TransferItem></TransferItem>'],
    [Tree, '树', '<Tree></Tree>'],
    [TreeNode, '树', '<TreeNode></TreeNode>'],
    ...
    [TypographyText, '排版', '<TypographyText></TypographyText>'],
