...
export function getComponentMap() {
  return [
    ...
    [ContextMenuSubTrigger, '上下文菜单', '<ContextMenuSubTrigger></ContextMenuSubTrigger>'],
    [ContextMenuTrigger, '上下文菜单', '<ContextMenuTrigger></ContextMenuTrigger>'],
    ...
    [MenubarSubTrigger, '菜单栏', '<MenubarSubTrigger></MenubarSubTrigger>'],
    [MenubarTrigger, '菜单栏', '<MenubarTrigger></MenubarTrigger>'],
    [NavigationMenuContent, '导航菜单', '<NavigationMenuContent></NavigationMenuContent>'],
    [NavigationMenuIndicator, '导航菜单', '<NavigationMenuIndicator></NavigationMenuIndicator>'],
